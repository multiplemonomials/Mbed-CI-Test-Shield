...
utest::v1::status_t test_setup(const size_t number_of_cases)
{
    ...
    GREENTEA_SETUP(40, "spi_basic_test");
...
Case cases[] = {
        ...
        Case("SPI - SD card present (1MHz)", test_card_present<1000000>),
		Case("SPI - Mount FS, Create File (1MHz)", mount_fs_create_file<1000000>),
		Case("SPI - Write, Read, and Delete File (1MHz)", test_sd_file<1000000>),
};
